// Auto-generated from services\pcv.h
...
public enum PcvClockRatesListType
{
...
public static class Pcv
{
    public static extern Result pcvInitialize();
    public static extern void pcvExit();
    public static extern IntPtr pcvGetServiceSession();
    public static extern Result pcvGetModuleId(ref PcvModuleId module_id, PcvModule module);
    public static extern Result pcvGetClockRate(PcvModule module, ref u32 out_hz);
    public static extern Result pcvSetClockRate(PcvModule module, u32 hz);
    public static extern Result pcvSetVoltageEnabled(u32 power_domain, bool state);
    public static extern Result pcvGetVoltageEnabled(ref bool isEnabled, u32 power_domain);
    public static extern Result pcvGetPossibleClockRates(PcvModule module, ref u32 rates, s32 max_count, ref PcvClockRatesListType out_type, ref s32 out_count);
}
